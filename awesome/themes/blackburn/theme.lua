...
awful.util.tagnames   = { "HEY", "CHEW", "LOOK", "HE", "RE" }
...
-- Calendar (only attach to main monitor)
...
function theme.at_screen_connect(s)
    ...
    if s == screen[2] then
        -- Customize wibar for the main screen
        s.mywibox:setup {
        ...
        -- Wibar for the secondary screen
        s.mywibox:setup {
            layout = wibox.layout.align.horizontal,
            { -- Left widgets
                layout = wibox.layout.fixed.horizontal,
